...
export const sampleData = {
  ...
  module_6: {
    ...
    ego: "Controller",
    ego_statement: "Management",
    external_wound_word: "Criticism",
    external_connetion: "Validation",
    external_grounding: "Achievement",
  ...
  module_7: {
    ...
    alignment_statement_1: "[M07 Alignment Statement 1]",
    balanced_sensuality: "[M07 Balanced Sensuality (Center)]",
...
export const hardCodedData = {
  ...
  module_6: {
    ...
    internal_step_2_hard_coded: "If you made the right decision, stand firm. If not, be accountable in a clearing conversation",
